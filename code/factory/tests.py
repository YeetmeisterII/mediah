...
class TestCreatureCreationMethods(unittest.TestCase):
    ...
    def test_create_custom_creature(self):
        ...
        self.assertEqual(creature.stats().physicality_base(), 7)

    def test_default_goblin_creation(self):
        creature = Factory().create_creature("goblin")
        self.assertEqual(creature.stats().constitution(), 10)
        self.assertEqual(creature.stats().physicality_base(), 5)
        self.assertEqual(creature.stats().dexterity_base(), 10)
    ...
    def test_default_orc_creation(self):
        ...
        self.assertEqual(creature.stats().constitution(), 15)
        self.assertEqual(creature.stats().physicality_base(), 13)
        self.assertEqual(creature.stats().dexterity_base(), 13)
        self.assertEqual(creature.stats().social(), 0)
    ...
    def test_default_earth_elemental_creation(self):
        ...
        self.assertEqual(creature.stats().constitution(), 5)
    ...
    def test_default_djinn_creation(self):
        ...
        self.assertEqual(creature.stats().physicality_base(), 5)
        self.assertEqual(creature.stats().dexterity_base(), 16)
        self.assertEqual(creature.stats().social(), 17)
        self.assertEqual(creature.gold_worth(), 30)
        self.assertEqual(creature.experience_worth(), 15)

    def test_default_dragon_creation(self):
        creature = Factory().create_creature("dragon")
        self.assertEqual(creature.stats().constitution(), 30)
        self.assertEqual(creature.stats().physicality_base(), 18)
        self.assertEqual(creature.stats().dexterity_base(), 18)
        self.assertEqual(creature.stats().social(), 0)
    ...
    def test_default_human_creation(self):
        ...
        self.assertEqual(creature.stats().constitution(), 10)
        self.assertEqual(creature.stats().physicality_base(), 10)
        self.assertEqual(creature.stats().dexterity_base(), 10)
        self.assertEqual(creature.stats().social(), 10)
        self.assertEqual(creature.gold_worth(), 0)
