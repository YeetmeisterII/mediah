...
class Factory:
    @staticmethod
    def create_creature(creature_cls: str, stats: dict = None):
        """
    ...
    @staticmethod
    def create_weapon(weapon_cls: str, stats: dict = None):
        """
    ...
    @staticmethod
    def equip_creature(creature: "Creature", weapon: "Weapon"):
        """
